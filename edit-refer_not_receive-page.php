...
if (isset($_POST['btneditAll'])) {
    try {
        ...
        $sql = "SELECT id FROM refer_not_receive";
        ...
        if ($id) {
            ...
            header("Location: edit-refer_not_receive.php?id=$id");
            exit;
        } else {
...
if (isset($_POST['btnNo'])) {
    header("Location:refer_not_receive.php");
    exit;
}
...
<head>
    <title>Edit Refer Not Receive | - Dashboard</title>
