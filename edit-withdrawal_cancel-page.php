...
if (isset($_POST['btneditAll'])) {
    try {
        ...
        $sql = "SELECT id FROM withdrawal_cancel";
        ...
        if ($id) {
            ...
            header("Location: edit-withdrawal_cancel.php?id=$id");
            exit;
        } else {
...
if (isset($_POST['btnNo'])) {
    header("Location:withdrawal_cancel.php");
    exit;
}
...
<head>
    <title>Edit Withdrawal Cancel | - Dashboard</title>
