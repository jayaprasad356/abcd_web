...
if (isset($_POST['btnEdit'])) {
        ...
        $sql_query = "UPDATE withdrawal_cancel SET account_num='$account_num',ifsc_code='$ifsc_code',bank_name='$bank_name',remarks='$remarks',status=$status,chat_support='$chat_support',users_name='$users_name',project='$project',total_codes_done='$total_codes_done',total_refer_counts='$total_refer_counts',level='$level',duration='$duration',worked_days='$worked_days',main_wallet_balance='$main_wallet_balance',monthly_balance='$monthly_balance',bonus_wallet='$bonus_wallet',l_refer_counts='$l_refer_counts' WHERE id =  $ID";
        $db->sql($sql_query);
            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id='users_table' class="table table-hover" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=withdrawal_cancel" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc" data-show-export="true" data-export-types='["txt","csv"]' data-export-options='{
